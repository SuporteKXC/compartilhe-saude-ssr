...
@Component({
  selector: 'app-modal-perguntas-frequentes',
  templateUrl: './modal-perguntas-frequentes.component.html',
  styleUrls: ['./modal-perguntas-frequentes.component.scss']
})
export class ModalPerguntasFrequentesComponent {
